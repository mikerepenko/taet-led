...
public class ShopBuy : MonoBehaviour
{
        ...
        if (ShopControl.isPosition == 2)
            if (PlayerPrefs.GetInt("BuySave16") != 1)
                if (PlayerPrefs.GetInt("buyCar") == 6)
                    if (PlayerPrefs.GetInt("Money") >= 500000)
                    {
			...
			if (PlayerPrefs.GetInt ("BuySave19") != 1)
				if (PlayerPrefs.GetInt ("buyCar") == 9)
					if (PlayerPrefs.GetInt ("Money") >= 500000) {
						...
						buyFailed.SetActive(true);
		if (ShopControl.isPosition == 2)
		if (PlayerPrefs.GetInt ("BuySave110") != 1)
		if (PlayerPrefs.GetInt ("buyCar") == 10)
		if (PlayerPrefs.GetInt ("Money") >= 500000) {
			PlayerPrefs.SetInt ("Money", PlayerPrefs.GetInt ("Money") - 500000);
    ...
    void OnMouseUpAsButton()
    {
		...
		case "Button110":
			...
			if (PlayerPrefs.GetInt("BuySave110") == 0)
				priceShop.text = "Цена: " + "500000";
			else
			{
				priceShop.text = "";
            ...
            case "BackCar":
                ...
                if (PlayerPrefs.GetInt("isScrollCar") > 1)
                    ...
                    PlayerPrefs.SetInt("isScrollCar", 8);
                priceShop.text = "";
                buyFailed.SetActive(false);
                break;
